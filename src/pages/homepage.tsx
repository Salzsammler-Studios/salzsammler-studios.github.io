...
const Homepage = () => {
    return <Box minH={"105vh"}>
        <Box pointerEvents={"none"} marginLeft={"-18rem"} marginTop={"-25rem"} bgSize={"100%"}width={"100%"} height={"100%"} position={"absolute"} bgImage={"url('/cloudsTogether.png')"} bgRepeat={"no-repeat"} bgPosition={"left top"}></Box>
        ...
        <SimpleGrid columns={2} spacing={10}>
            ...
            <Box></Box>
            <Box></Box>
            <Stack marginTop={"16rem" }maxW="103%" marginLeft={["-3rem","-3rem"]} paddingRight={["2rem","3rem"]}>
