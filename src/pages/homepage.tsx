...
const Homepage = () => {
    return <Box minH={"105vh"}>
        ...
        <Box pointerEvents={"none"} marginLeft={"-0.1rem"} position={"absolute"} width={"100%"} height={"100%"} bgImage={homepage_background} bgPosition="left bottom" bgRepeat="no-repeat" bgSize="50%"/>
