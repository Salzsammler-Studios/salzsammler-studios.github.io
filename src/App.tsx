...
import { Box, Image, Tab, Tabs, TabList, TabPanel, TabPanels } from '@chakra-ui/react';
...
const App = () => {
    return <Box>
        <Tabs align='end' position="relative" variant='unstyled' isLazy size={['md','lg']}>
            ...
            <TabPanels>
                ...
                <TabPanel sx={{margin: 0, padding: 0}}><Project/></TabPanel>
                <TabPanel sx={{margin: 0, padding: 0}}><AboutUs/></TabPanel>
